...
var handler = map[string]func(proto.Message, *player.Player) proto.Message{
	...
	"pb.DownCreateBattleRoom":            DownCreateBattleRoom,
	"pb.DownJoinBattleRoom":              DownJoinBattleRoom,
	"pb.DownJoinBattleRoomToOtherPlayer": DownJoinBattleRoomToOtherPlayer,
	"pb.DownStartBattle":                 DownStartBattle,
	"pb.DownStartBattleToOtherPlayer":    DownStartBattleToOtherPlayer,
	"pb.DownGameStartToAll":              DownGameStartToAll,
